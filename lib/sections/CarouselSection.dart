...
class _CarouselSectionState extends State<CarouselSection> {
  final CarouselController btnCarousel =
      CarouselController(); // creation de boutons du carousell

  @override
  Widget build(BuildContext context) {
    int index = widget.depthIndex; // deinition de l'index de  départ

    final items =
        cimages.map((image) => card(image)).toList(); // recuperation des images
    ...
    return Column(
      // 1 colone, 1 titre de esction, boutons et carousel
      children: [
        Row(
          // titre de section
          children: [
            TitleText(string: "le carousel des dieux"),
        ...
        Padding(
          ...
          child: Card(
            color: appBarColor,
            elevation: 5, // decalage en hauteurn effet de suspension
            child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
              children: [
                ...Iterable<int>.generate(cimages.length)
